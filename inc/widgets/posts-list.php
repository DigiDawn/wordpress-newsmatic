<?php
/**
 * Adds Newsmatic_Posts_List_Widget widget.
 * 
 * @package Newsmatic
 * @since 1.0.0
 */
class Newsmatic_Posts_List_Widget extends WP_Widget {
    /**
    ...
    public function __construct() {
        parent::__construct(
            ...
            esc_html__( 'Newsmatic : Posts List', 'newsmatic' ),
            array( 'description' => __( 'A collection of posts from specific category displayed in list layout.', 'newsmatic' ) )
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $image_ratio = isset( $instance['image_ratio'] ) ? $instance['image_ratio'] : json_encode(array('desktop'   => 0.5,'tablet'    => 0.5,'smartphone'=> 0.5));
    ...
    ?>
            <div class="posts-wrap posts-list-wrap feature-post-block layout-three">
                <?php
                    $post = new WP_Query( 
                        array( 
                            ...
                            <div class="post-item format-standard newsmatic-category-no-bk">
                                <div class="post_thumb_image post-thumb <?php if( !$thumbnail_url ) echo esc_attr('no-feat-img'); ?>">
                                    <?php
                                        ...
                                        if( $numbering > 1 ) echo '<span class="post-numbering">' . newsmatic_numbering_with_pad_format($numbering). '</span>';
                                    ?>
                                </div>
                                <div class="post-content-wrap card__content">
                                    ...
                                    <div class="newsmatic-post-title card__content-title post-title">
                                        ...
                                        <?php if( $numbering == 1 ) echo '<span class="post-numbering">' . newsmatic_numbering_with_pad_format($numbering). '</span>'; ?>
                                    </div>
                                    <?php
                                        if( $numbering == 1 ) : ?>
                                            <div class="post-meta">
...
} // class Newsmatic_Posts_List_Widget